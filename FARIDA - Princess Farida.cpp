...
int a,b,d,e,f,g,h,l,i,j,k,m,n,o,p,q,r,s,t,u,v,w,x,y,z,pos,res,res1,test,cnt,cnt1,cnt2,cnt3,cnt4,sum,sum1,sum2,sum3,ans,ans1,ans2,ans3,ma,ma1,ma2,ma3,mi,mi1,mi2,mi3,temp,temp1,temp2,temp3,temp4;
...
void SectumSempra()
{
	...
	lp1(i,3,n-1){
		dp[i]=max({dp[i-1],dp[i-2]+v[i],dp[i-3]+v[i]});
	}
	cout<<dp[n-1];
	lol
}
